...
map.getView().fit([12548250.955904, -812709.062374, 12553349.519581, -808613.948500], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Aksesibilitas Halte di Kecamatan genteng</h2>';
        return titleElement;
    })(),
